        ...
        "status"|"sts")
            ...
            while true; do
                ...
                if [ "$target_sub" == "hws" ]; then
                    ...
                    local sys_info=""
                    sys_info+="${C_PURPLE} Commander ID :${C_WHITE} ${MUX_ID:-Unknown}${C_RESET}\n"
                    ...
                    sys_info+="${C_PURPLE} Timeline     :${C_WHITE} v${MUX_VERSION} ${C_PURPLE}@$(git symbolic-ref --short HEAD 2>/dev/null)${C_RESET}\n"
                    ...
                    local row=""
                    printf -v row " ${C_PURPLE}%-12s :${C_WHITE} %-6s  ${C_PURPLE}%-12s :${C_WHITE} %-6s${C_RESET}\n" "Heap Alloc" "${HEAP_ALLOCATION_IDX:-0}" "I/O Writes" "${IO_WRITE_CYCLES:-0}"
                    sys_info+="$row"
